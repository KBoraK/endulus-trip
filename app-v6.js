...
function renderStays(){
 ...
 (alts.length?'<div class="head" style="margin-top:22px"><div><div class="ey">KARAR LİSTESİ · 3 YETİŞKİN</div><h2>'+escapeHtml(stayCity)+' alternatifleri</h2></div><span class="pill">'+(stayCity==="Granada"?"25–27 Ara":"23–25 Ara")+' · 2 gece</span></div><p class="muted">Fiyatlar 19.09.2026 tarihinde 3 yetişkin için görülen toplam fiyatlardır; rezervasyona kadar değişebilir.</p><div class="v6staygrid">'+alts.map(a=>'<article class="v6stay"><div class="v6staytop"><div><div class="ey">'+escapeHtml(a.type)+' · '+escapeHtml(a.area)+'</div><h3>'+escapeHtml(a.name)+'</h3></div></div><div class="v6summary">'+(a.rating?'<b>'+escapeHtml(a.rating)+'</b><br>':"")+'2 gece · 3 kişi<br><b>📍 Merkez: '+escapeHtml(a.center||'—')+'</b><br><b>'+money(a.price)+'</b> · güncel toplam</div><div class="actions">'+(a.url?'<a class="action primary" target="_blank" rel="noopener" href="'+a.url+'">'+(a.type.startsWith("Airbnb")?"Airbnb":"Booking.com")+' ↗</a>':"")+'<a class="action" target="_blank" rel="noopener" href="'+maps(a.name+" "+stayCity)+'">⌖ Harita</a></div></article>').join("")+'</div>':'<div class="v5warn" style="margin-top:18px">Bu şehir için karar verdiğimiz alternatifler henüz eklenmedi.</div>');
