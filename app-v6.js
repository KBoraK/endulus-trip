(()=>{
"use strict";
window.ENDULUS_APP_BUILD="6.2.24";
...
if(stayDefaults.Montpellier)Object.assign(stayDefaults.Montpellier,{status:"booked",name:"Campanile PRIME - Montpellier Centre St Roch",area:"Centre · Gare Saint-Roch · 11 rue Pagezy"});
...
const DAY_FOOD={
  ...
  12:[["Campanile kahvaltısı","Otelde varsa en pratik başlangıç"],["Bonobo","Alternatif brunch · kahve"],["Ripailles","Öğle/akşam · Fransız bistro"],["Bistrot Sainte Anne","Écusson · bistro"]],
  13:[["Campanile kahvaltısı","Erken ve risksiz seçenek"],["Bonobo","Yalnız zaman uygunsa kısa kahve"]]
};
