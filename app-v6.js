...
const stayAlternatives={
 ...
 "Madrid":[
  ...
  {name:"B&B HOTEL Madrid Vallecas La Gavia",price:275.40,rating:"8,8 · 974 yorum",type:"Otel · 3★",area:"Villa de Vallecas · La Gavia",center:"~8 km · Madrid merkezi",note:"C. de Villalcón 3'te, Madrid'in güneydoğusunda. Booking canlı aramasında 30 Ara–1 Oca, 3 yetişkin için toplam €275,40. Merkeze mesafeyi sadece km olarak değil toplu taşıma bağlantısıyla değerlendirmek gerekir.",pros:"Yeni/modern 3★ otel; 8,8 Booking puanı; 24 saat resepsiyon. Merkez dışı olmasına rağmen toplu taşıma kullanılarak Madrid merkezine gidilebilir; fiyatı merkezi seçeneklerden belirgin düşükse mantıklı olabilir.",cons:"Puerta del Sol/Prado çevresine yürünebilir değil; her merkez günü toplu taşıma gerektiriyor. Özellikle 31 Aralık gece dönüşünde sefer ve yılbaşı ulaşım düzenlemeleri ayrıca kontrol edilmeli.",geniusNote:"💡 Genius kontrolü: Booking.com hesabınla giriş yapınca bu tesiste Genius veya üyeye özel ek indirim olup olmadığını rezervasyon öncesi tekrar kontrol et.",url:"https://www.booking.com/hotel/es/b-amp-b-madrid-vallecas-la-gavia.html?aid=2438770&checkin=2026-12-30&checkout=2027-01-01&no_rooms=1&group_adults=3&selected_currency=EUR"}
 ],
 "Córdoba":[
