...
const stayAlternatives={
 ...
 "Montpellier":[
  ...
  {name:"Best Western Hotel Le Guilhem",price:199.01,rating:"8,2 · 1.250 yorum",type:"Otel · 3★",area:"Écusson · Rue Jean-Jacques Rousseau",center:"~0,9 km · Place de la Comédie",note:"18 Rue Jean-Jacques Rousseau. 1–3 Oca, 2 yetişkin için Booking canlı toplam €199,01. Écusson'un tarihi bölümünde, Peyrou ve Saint-Pierre tarafına çok yakın.",pros:"Bizim Montpellier yürüyüş programına en atmosferik konumlardan biri; tarihi merkez, Arc de Triomphe, Peyrou ve katedral hemen çevrede.",cons:"Eklo/Campanile'den daha pahalı; Saint-Roch istasyonuna yürüyüş daha uzun.",geniusNote:"💡 Genius kontrolü: Booking.com hesabınla giriş yapınca Genius veya üyeye özel ek indirim olup olmadığını kontrol et.",url:"https://www.booking.com/hotel/fr/le-guilhem.html?aid=2438770&checkin=2027-01-01&checkout=2027-01-03&no_rooms=1&group_adults=2&selected_currency=EUR"},
...
function renderStays(){
 ...
 (alts.length?'<div class="head" style="margin-top:22px"><div><div class="ey">KARAR LİSTESİ · 3 YETİŞKİN</div><h2>'+escapeHtml(stayCity)+' alternatifleri</h2></div><span class="pill">'+(stayCity==="Granada"?"25–27 Ara":stayCity==="Córdoba"?"27–28 Ara":stayCity==="Sevilla"?"28–30 Ara":stayCity==="Madrid"?"30 Ara–1 Oca":"23–25 Ara")+' · 2 gece</span></div><p class="muted">Fiyatlar 19.09.2026 tarihinde 3 yetişkin için görülen toplam fiyatlardır; rezervasyona kadar değişebilir.</p><div class="v6staygrid">'+alts.map(a=>'<article class="v6stay"><div class="v6staytop"><div><div class="ey">'+escapeHtml(a.type)+' · '+escapeHtml(a.area)+'</div><h3>'+escapeHtml(a.name)+'</h3></div></div><div class="v6summary">'+(a.rating?'<b>'+escapeHtml(a.rating)+'</b><br>':"")+'2 gece · 3 kişi<br><b>📍 Merkez: '+escapeHtml(a.center||'—')+'</b><br><b>'+money(a.price)+'</b> · güncel toplam</div><div class="actions">'+(a.url?'<a class="action primary" target="_blank" rel="noopener" href="'+a.url+'">'+(a.type.startsWith("Airbnb")?"Airbnb":"Booking.com")+' ↗</a>':"")+'<a class="action" target="_blank" rel="noopener" href="'+maps(a.name+" "+stayCity)+'">⌖ Harita</a></div>'+(a.note?'<div class="v5warn" style="margin-top:12px"><b>Konum notu:</b> '+escapeHtml(a.note)+'</div>':'')+(a.pros?'<div class="v6summary" style="margin-top:10px"><b>✓ Avantajlar</b><br>'+escapeHtml(a.pros)+'</div>':'')+(a.cons?'<div class="v6summary" style="margin-top:8px"><b>− Dezavantajlar</b><br>'+escapeHtml(a.cons)+'</div>':'')+(a.geniusNote?'<div class="v5warn" style="margin-top:10px"><b>Genius:</b> '+escapeHtml(a.geniusNote)+'</div>':'')+'</article>').join("")+'</div>':'<div class="v5warn" style="margin-top:18px">Bu şehir için karar verdiğimiz alternatifler henüz eklenmedi.</div>');
