...
const stayAlternatives={
 ...
 "Sevilla":[
  {name:"Airbnb · 635203765526746475",price:196,rating:"",type:"Airbnb · Apartman",area:"Los Remedios · Plaza de Cuba / Av. República Argentina civarı (Airbnb harita pini, yaklaşık)",center:"~1,2 km · Sevilla Katedrali",url:"https://www.airbnb.de/rooms/635203765526746475?unique_share_id=a90c93e3-e12b-4fa8-ae27-2548de6960f8&viralityEntryPoint=1&s=76"},
  ...
  {name:"Airbnb · 1006965952595172368",price:238,rating:"",type:"Airbnb · Apartman",area:"Sevilla · konum teyit edilecek",center:"—",url:"https://www.airbnb.de/rooms/1006965952595172368?unique_share_id=5bd88d85-6036-4530-a7fd-c889306eb258&viralityEntryPoint=1&s=76"}
 ],
 "Córdoba":[
  ...
  {name:"La Corte de Isabel",price:79,rating:"8,9 · 108 yorum",type:"Apartman",area:"Centro · Calle Isabel II",center:"~1,2 km · Mezquita-Catedral",url:"https://www.booking.com/hotel/es/la-corte-de-isabel.html?aid=2438770&checkin=2026-12-27&checkout=2026-12-28&no_rooms=1&group_adults=3&selected_currency=EUR"},
  {name:"Califa SuitesGP",price:103,rating:"8,8 · 405 yorum",type:"Apartman",area:"Centro · Campo Madre de Dios",center:"~1,1 km · Mezquita-Catedral",url:"https://www.booking.com/hotel/es/mezquitasuitesgp.html?aid=2438770&checkin=2026-12-27&checkout=2026-12-28&no_rooms=1&group_adults=3&selected_currency=EUR"},
  {name:"Vial Suites GP",price:104,rating:"8,7 · 260 yorum",type:"Apartman",area:"Vial Norte · Antonio de la Torre y del Cerro",center:"~2,0 km · Mezquita-Catedral",url:"https://www.booking.com/hotel/es/vial-suites-gp.html?aid=2438770&checkin=2026-12-27&checkout=2026-12-28&no_rooms=1&group_adults=3&selected_currency=EUR"}
 ],
 "Granada":[
...
function renderStays(){
 ...
 (alts.length?'<div class="head" style="margin-top:22px"><div><div class="ey">KARAR LİSTESİ · 3 YETİŞKİN</div><h2>'+escapeHtml(stayCity)+' alternatifleri</h2></div><span class="pill">'+(stayCity==="Granada"?"25–27 Ara":stayCity==="Córdoba"?"27–28 Ara":stayCity==="Sevilla"?"28–30 Ara":"23–25 Ara")+' · 2 gece</span></div><p class="muted">Fiyatlar 19.09.2026 tarihinde 3 yetişkin için görülen toplam fiyatlardır; rezervasyona kadar değişebilir.</p><div class="v6staygrid">'+alts.map(a=>'<article class="v6stay"><div class="v6staytop"><div><div class="ey">'+escapeHtml(a.type)+' · '+escapeHtml(a.area)+'</div><h3>'+escapeHtml(a.name)+'</h3></div></div><div class="v6summary">'+(a.rating?'<b>'+escapeHtml(a.rating)+'</b><br>':"")+'2 gece · 3 kişi<br><b>📍 Merkez: '+escapeHtml(a.center||'—')+'</b><br><b>'+money(a.price)+'</b> · güncel toplam</div><div class="actions">'+(a.url?'<a class="action primary" target="_blank" rel="noopener" href="'+a.url+'">'+(a.type.startsWith("Airbnb")?"Airbnb":"Booking.com")+' ↗</a>':"")+'<a class="action" target="_blank" rel="noopener" href="'+maps(a.name+" "+stayCity)+'">⌖ Harita</a></div></article>').join("")+'</div>':'<div class="v5warn" style="margin-top:18px">Bu şehir için karar verdiğimiz alternatifler henüz eklenmedi.</div>');
