...
const stayAlternatives={
 "Málaga":[
  ...
  {name:"Airbnb · 1715238413556590874",price:null,rating:"",type:"Airbnb",area:"Málaga · konum Airbnb'den kontrol edilecek",center:"—",note:"Bu seçenek kullanıcı tarafından Málaga konaklama listesine eklendi. Airbnb sayfası dışarıdan detay vermediği için konum, fiyat ve puan burada tahmin edilmedi.",pros:"Doğrudan paylaşılan Airbnb seçeneği; 23–25 Aralık konaklaması için karar listesinde tutuluyor.",cons:"Fiyat, puan ve kesin konum henüz dashboard'a aktarılmadı; rezervasyondan önce Airbnb sayfasından kontrol edilmeli.",url:"https://www.airbnb.de/properties/1715238413556590874?unique_share_id=57229741-23f2-40d2-b7fc-5e980ed66fb8&viralityEntryPoint=1&s=76&anchor_room_id=26437687",map:false},
  {name:"Airbnb · 1715253353160267450",price:259,rating:"",type:"Airbnb",area:"Málaga · konum Airbnb'den kontrol edilecek",center:"—",note:"Bu seçenek kullanıcı tarafından Málaga konaklama listesine eklendi. Kesin konum ve puan Airbnb sayfasından kontrol edilmeli.",pros:"23–25 Aralık için doğrudan paylaşılan Airbnb alternatifi; toplam fiyat 259 €.",cons:"Kesin konum ve puan henüz dashboard'a aktarılmadı.",url:"https://www.airbnb.de/properties/1715253353160267450?unique_share_id=3de1e05b-ca24-4830-a491-cd329fa7dc42&viralityEntryPoint=1&s=76&anchor_room_id=48579718",map:false}
 ],
 "Sevilla":[
 ...
 "Madrid":[
  ...
  {name:"B&B HOTEL Madrid Vallecas La Gavia",price:275.40,rating:"8,8 · 974 yorum",type:"Otel · 3★",area:"Villa de Vallecas · La Gavia",center:"~8 km · Madrid merkezi",note:"C. de Villalcón 3, Villa de Vallecas. En yakın pratik metro Congosto (L1): yaklaşık 1,8 km / 21 dk yürüyüş. Congosto → Sol L1 ile aktarmasız yaklaşık 25 dk; otelden merkeze toplam yolculuk yaklaşık 45 dk düşünülmeli. Cercanías Vallecas yaklaşık 2,2 km / 27 dk yürüyüşte olduğundan günlük kullanımda metro L1 daha mantıklı.",pros:"Metro L1 doğrudan Sol, Gran Vía, Antón Martín, Estación del Arte ve Atocha hattından geçiyor; Congosto'dan merkeze aktarma gerekmiyor. 8,8 Booking puanı ve 3★ normal otel konforu da güçlü tarafı.",cons:"Asıl dezavantaj ilk/son kilometre: Congosto metroya yaklaşık 21 dk yürümek gerekiyor. Her merkez gidiş-dönüşünde bu süre ekleniyor. 31 Aralık gecesi metro ve gece ulaşımının özel NYE saatleri ayrıca kontrol edilmeli.",geniusNote:"💡 Genius kontrolü: Booking.com hesabınla giriş yapınca bu tesiste Genius veya üyeye özel ek indirim olup olmadığını rezervasyon öncesi tekrar kontrol et.",url:"https://www.booking.com/hotel/es/b-amp-b-madrid-vallecas-la-gavia.html?aid=2438770&checkin=2026-12-30&checkout=2027-01-01&no_rooms=1&group_adults=3&selected_currency=EUR"}
 ],
 "Montpellier":[
...
function renderStays(){
 ...
 (alts.length?'<div class="head" style="margin-top:22px"><div><div class="ey">KARAR LİSTESİ · '+(stayCity==="Montpellier"?"2":"3")+' YETİŞKİN</div><h2>'+escapeHtml(stayCity)+' alternatifleri</h2></div><span class="pill">'+(stayCity==="Granada"?"25–27 Ara":stayCity==="Córdoba"?"27–28 Ara":stayCity==="Sevilla"?"28–30 Ara":stayCity==="Madrid"?"30 Ara–1 Oca":stayCity==="Montpellier"?"1–3 Oca":"23–25 Ara")+' · 2 gece</span></div><p class="muted">Fiyatlar 19.09.2026 tarihinde '+(stayCity==="Montpellier"?"2":"3")+' yetişkin için görülen toplam fiyatlardır; rezervasyona kadar değişebilir.</p><div class="v5warn" style="margin:10px 0 14px"><b>Booking Genius:</b> Booking.com hesabınla giriş yapınca listedeki tesislerde Genius veya üyeye özel ek indirim olup olmadığını rezervasyon öncesi kontrol et.</div><div class="v6staygrid">'+alts.map(a=>'<article class="v6stay"><div class="v6staytop"><div><div class="ey">'+escapeHtml(a.type)+' · '+escapeHtml(a.area)+'</div><h3>'+escapeHtml(a.name)+'</h3></div></div><div class="v6summary">'+(a.rating?'<b>'+escapeHtml(a.rating)+'</b><br>':"")+'2 gece · 3 kişi<br><b>📍 Merkez: '+escapeHtml(a.center||'—')+'</b><br>'+(a.price!=null?'<b>'+money(a.price)+'</b> · güncel toplam':'<b>Fiyatı Airbnb’de kontrol et</b>')+'</div><div class="actions">'+(a.url?'<a class="action primary" target="_blank" rel="noopener" href="'+a.url+'">'+(a.type.startsWith("Airbnb")?"Airbnb":"Booking.com")+' ↗</a>':"")+(a.map===false?"":'<a class="action" target="_blank" rel="noopener" href="'+maps(a.name+" "+stayCity)+'">⌖ Harita</a>')+'</div>'+(a.note?'<div class="v5warn" style="margin-top:12px"><b>Konum notu:</b> '+escapeHtml(a.note)+'</div>':'')+(a.pros?'<div class="v6summary" style="margin-top:10px"><b>✓ Avantajlar</b><br>'+escapeHtml(a.pros)+'</div>':'')+(a.cons?'<div class="v6summary" style="margin-top:8px"><b>− Dezavantajlar</b><br>'+escapeHtml(a.cons)+'</div>':'')+'</article>').join("")+'</div>':'<div class="v5warn" style="margin-top:18px">Bu şehir için karar verdiğimiz alternatifler henüz eklenmedi.</div>');
