(()=>{
"use strict";
window.ENDULUS_APP_BUILD="6.2.32";
...
const stayAlternatives={
 ...
 "Madrid":[
  ...
  {name:"Airbnb · La Elipa / Ventas",price:320,rating:"",type:"Airbnb · Apartman",area:"La Elipa / Ventas · Ciudad Lineal",center:"~4–5 km · Puerta del Sol",note:"Airbnb harita pinine göre Calle de San Emilio ile Calle de San Secundino çevresi; Horizon, Oficina de Correos ve Mi Alcampo yakınında. Airbnb rezervasyon öncesi exact kapı numarasını göstermediği için konum yaklaşık verilmiştir. Senin gördüğün fiyat: 30 Ara–1 Oca, 3 yetişkin için toplam €320.",pros:"3 kişi için €320 toplam; çevrede market, restoran ve günlük ihtiyaç noktaları var. La Elipa / Ventas tarafı, Madrid'in çok dışındaki otel seçeneklerine göre merkeze daha yakın.",cons:"Sol / Gran Vía / Barrio de las Letras kadar merkezi değil; 31 Aralık gecesi dönüşte metro/otobüs saatlerini ayrıca kontrol etmek gerekir. Exact adres ve check-in ayrıntıları rezervasyon ekranında teyit edilmeli.",url:"https://www.airbnb.de/rooms/1104900166361471701?adults=3&check_in=2026-12-30&check_out=2027-01-01&search_mode=regular_search&source_impression_id=p3_1790332545_P3WY6ee0iU9KkGvV&previous_page_section_name=1001&federated_search_id=b55fad07-f80d-44c1-ae0f-b976cce9938b&guests=3&room_id=1104900166361471701",mapQuery:"Calle de San Emilio, Madrid"},
  {name:"Airbnb · Puerta del Ángel",price:273,rating:"",type:"Airbnb · Apartman",area:"Puerta del Ángel · Latina",center:"~2,5–3 km · Puerta del Sol",note:"Airbnb harita pinine göre Puerta del Ángel'de, Calle de Caramuel / Calle de Doña Urraca / Calle de Juan Tornero çevresinde. Pin; Gozar Neotaberna Castiza, María Del Río ve La Siesta referanslarına yakın. Exact kapı numarası Airbnb tarafından rezervasyon öncesi gizleniyor. Senin gördüğün fiyat: 30 Ara–1 Oca, 3 yetişkin için toplam €273.",pros:"€273 toplamla Madrid alternatifleri içinde güçlü fiyat/konum dengesi. La Elipa seçeneğine göre merkeze daha yakın; Puerta del Ángel çevresinden Plaza Mayor / Callao yönüne direkt otobüs seçenekleri var ve tarihi merkeze yürüyüş de yaklaşık 30–40 dk bandında mümkün.",cons:"Sol'un içinde değil; yılbaşı gecesi geç dönüşte toplu taşıma saatleri ayrıca kontrol edilmeli. Exact adres ve check-in ayrıntıları rezervasyon ekranında teyit edilmeli.",url:"https://www.airbnb.de/rooms/1757392744346382547?unique_share_id=e05b6fe9-d46a-4704-b49f-5ad610b31432&viralityEntryPoint=1&s=76",mapQuery:"Calle de Caramuel, Puerta del Ángel, Madrid"}
 ],
 "Montpellier":[
